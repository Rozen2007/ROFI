            ...
            <div className="fontStyler">
                ...
                <div className="gridOne">
                    <div className="fontFamily" style={{marginBottom: "1.5rem"}}>
                            ...
                            <InputLabel   className="inputLabel" id="font-label">Fonts</InputLabel>
                            <Select
                                    className="select"
                                    labelId="font-label"
                        ...
                        <div className="fontSize" style={{marginBottom: "1.5rem"}}>
                            <FormControl style={{minWidth: 150}}>
                                <InputLabel className="inputLabel" id="fontSize-label" >Font Size</InputLabel>
                                <Select
                                value={fontSize}
                                className="select"
                            ...
                            <div className="fontWeight" style={{marginBottom: "1.5rem"}}>
                                <InputLabel className="inputLabel" id="fontWeight">Font Weight</InputLabel>
                            ...
                            <div className="letterSpacing" style={{marginBottom: "1.5rem"}}>
                                <FormControl style={{minWidth: 150}}>
                                    <InputLabel className="inputLabel" id="letterSpacing-label">Letter Spacing</InputLabel>
                                    <Select
                                    className="select"
                                    value={letterSpacing}
                            ...
                            <div className="wordSpacing" style={{marginBottom: "1.5rem"}}>
                                <FormControl style={{minWidth: 150}}>
                                    <InputLabel className="inputLabel" id="wordSpacing-label">Word Spacing</InputLabel>
                                    <Select
                                    value={wordSpacing}
